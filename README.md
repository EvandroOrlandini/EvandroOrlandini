...
- <img src="https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/64/000000/external-money-banking-and-finance-kiranshastry-lineal-color-kiranshastry.png" /> Sou Administrador, apaixonado por Gestão de Projetos, Desenvolvimento Empresarial e criação de soluções que otimizem processos, sistemas e resultados; sou embaixador DIO Campus Expert criando e divulgando conteúdos de oportunidades de tecnologia;  trabalho Desenvolvedor WordPress;construindo uma carreira como Desenvolvedor Fullstack
